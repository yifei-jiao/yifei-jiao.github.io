...
Our SPH code incorporates an equation of state, material strength, fragmentation, porosity, and self-gravity with a k-d tree.
And the code is publicly available now! See the documentation for details https://sphsol-tutorial.readthedocs.io.
